...
def parse_parity(data):
    ...
    return {
        'last': None if latest is None else {
            ...
            'speed': latest.get('speed'), 'correcting': bool(latest.get('correcting'))},
        'running': bool(latest.get('running')) if latest else False,
        'paused': bool(latest.get('paused')) if latest else False,
        'runs': len(history),
    }
